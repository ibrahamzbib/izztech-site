          ...
          <AnimatePresence mode="wait">
            {!expanded ? (
              ...
              >
                ...
                <a href="tel:+17728886560" className="flex items-center gap-4 group">
                  <div className="w-10 h-10 shrink-0 rounded-full bg-accent-1/30 flex items-center justify-center text-accent-3 group-hover:bg-accent-3 group-hover:text-white transition-colors">
                  ...
                  <div>
                    ...
                    <div className="text-text-primary font-medium text-sm">(772) 888-6560</div>
                  </div>
                </a>

                <a href="https://www.linkedin.com/in/ibrahamzbib/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group">
                  <div className="w-10 h-10 shrink-0 rounded-full bg-accent-1/30 flex items-center justify-center text-accent-3 group-hover:bg-accent-3 group-hover:text-white transition-colors">
